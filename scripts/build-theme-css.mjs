...
function emitFoundationSizeTokens(t, set) {
  // Public spacing CSS vars — 8pt scale only (`--cube-space-1x`, `1.5x`, …).
  // Raw px keys (`sizes.space`) stay in theme.json for internal token resolution.
  emitNestedStringVars(t.sizes?.spaceScale, [], "space", set);
